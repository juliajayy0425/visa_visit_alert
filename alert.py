...
trip_date = datetime(2025, 2, 24)  # What is the latest appointment you want? 
sessions_token = "https://www.ch-edoc-reservation.admin.ch/#/session?token=2ZasJAtF&locale=en-US" # Obtain this link from the email directly
